...
func init() {
	m.Register(func(db dbx.Builder) error {
		...
		collection.DeleteRule = types.Pointer("@request.auth.collectionName = \"users\" && @request.auth.role = \"admin\"")
		...
		collection.DeleteRule = types.Pointer("@request.auth.collectionName = \"users\"")
