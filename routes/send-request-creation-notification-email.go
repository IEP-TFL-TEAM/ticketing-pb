...
func SendRequestCreationNotification(app *pocketbase.PocketBase) {
	app.OnBeforeServe().Add(func(e *core.ServeEvent) error {
		e.Router.POST(
			"/api/send-request-creation-notification",
			func(c echo.Context) error {
				...
				html, _ := registry.LoadFiles(
					"templates/request-creation-email.html",
					...
					"action":    "A new Change Request has been Created!",
				})
